...
Por este motivo, es necesario diseñar un programa que solicite las ventas (en kilos) de cada semestre para cada fruta. 
...
public class Fruteria_Matematica {
    public static void main(String[] args) {
         ...
         System.out.printf("El importe total es: %.4f € \n", importe_Total);
